...
| M2 数据与评测前置 | `IN_PROGRESS` | 固定来源/许可导入、规范化/Dedup/Split、Qwen3 Mask、Token 平衡/Packing/Manifest、不可变 Registry、完整固定源/离线重建、M2.4a Exact 污染契约、300 条领域集及真实 Exact 扫描、M2.4c Baseline 契约与 GPU Smoke | #47 clean-main 全量 Baseline 与 40 条人工判断 |

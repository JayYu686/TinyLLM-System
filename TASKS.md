...
| M2 数据与评测前置 | `IN_PROGRESS` | 固定来源/许可导入、规范化/Dedup/Split、Qwen3 Mask、Token 平衡/Packing/Manifest、不可变 Registry，以及干净提交上的完整固定源/离线重建 | #11 污染检查、冻结评测集与训练前 Baseline Evaluation |

...
| M2 数据与评测前置 | `IN_PROGRESS` | 固定来源/许可导入、规范化/Dedup/Split、Qwen3 Mask、Token 平衡/Packing/Manifest、不可变 Registry、完整固定源/离线重建，以及 M2.4a Exact 污染契约 | #46 冻结 300 条领域集并执行真实污染扫描；#47 训练前 Baseline Evaluation |

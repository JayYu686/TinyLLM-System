...
两个 R1 Seed 已完成 D2 真实 RTX 3090 重放。896 输出和 1536 前缀一致性全部通过，证明
原始失败可在冻结环境中精确重放。1024/1280/1536 的投影 Thinking 格式率分别为：

| Seed | 1024 | 1280 | 1536 |
| --: | --: | --: | --: |
| 42 | 95.0% | 97.0% | 98.0% |
| 20260727 | 95.5% | 96.0% | 96.5% |

冻结选择器返回 `length_ceiling_insufficient` 和退出码 6，没有修改正式评测协议。详细证据见
[M5.2-R2 中文报告](../reports/m5/m5_r2_diagnostic.md)和
[机器判定](../reports/m5/raw/m5_r2_length_diagnostic.json)。

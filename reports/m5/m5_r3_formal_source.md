...
R3 Mixture v2 已完成前瞻配置、标签重平衡、精确 Token 构建和重新打开校验，不需要重新
运行本轮 240 条 Qwen3-8B 生成。真实 Manifest 将单来源总使用上限冻结为 30，实际范围为
29–30，并授权两个固定 Seed 的 R3 训练。详见
[Mixture v2 中文报告](m5_r3_mixture.md)。

#!/usr/bin/env python3
"""Build the private exact-token M5.2-R1 format-repair mixture."""
...
from tinyllm.data import M5MixtureError, build_m5_format_repair_mixture


def build_parser() -> argparse.ArgumentParser:
    """Build the versioned R1 mixture interface."""
    ...
    parser.add_argument("--build-seed", type=int, default=20260727)
    return parser


def main() -> int:
    """Build, reopen, and print the content-addressed private R1 Manifest."""
